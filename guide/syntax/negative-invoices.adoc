...
.Example of invoice to be corrected
[source, xml, indent=0]
----
include::snippets/base-example.xml[tags=negative]
----
<1> Charge amount
...
.Example of credit note correcting the example invoice above
[source, xml, indent=0]
----
include::snippets/base-creditnote-correction.xml[tags=negative]
----
...
.Example of negative invoice correcting the example invoice above
[source, xml, indent=0]
----
include::snippets/base-negative-inv-correction.xml[tags=negative]
----
