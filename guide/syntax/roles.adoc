...
----
<1> schemeID attribute is mandatory for electronic addresses
<2> schemeID attribute is recommended for all party identifiers
<3> VAT identifiers must be prefixed with the country code
...
----
<1> VAT identifiers must be prefixed with the country code
