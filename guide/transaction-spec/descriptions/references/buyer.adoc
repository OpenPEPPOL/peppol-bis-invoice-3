...
If neither customer reference nor a reference to an order is supplied by the customer the name of the person ordering or appointed for the customer can be supplied in BuyerReference if known by the supplier. 


IMPORTANT: When reference is provided by the customer, the correct element MUST contain the provided reference.
