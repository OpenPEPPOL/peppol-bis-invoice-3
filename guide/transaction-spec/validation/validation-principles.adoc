...
* *Example rule text* +
_An invoice must have a buyers reference *or* an order reference_
...
* *Example rule text* +
_When the Seller is Swedish, the Legal Registration Number must be numeric with 10 digits._
