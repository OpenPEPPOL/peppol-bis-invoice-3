...
The diagram below shows the roles involved in the invoice and credit note transactions. The customer and invoice recipient is the same entity, as is the supplier and the invoice issuer.
