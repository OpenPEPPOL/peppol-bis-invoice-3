...
This specification is a Core Invoice Usage Spesification (CIUS) of {EN16931}, following the guidance given in chapter 7 of the {EN16931}. Any instance documents following this CIUS will allways be compliant with the European Standard ({EN16931}).
