  ...
  <pattern>
    <rule context="rsm:ExchangedDocumentContext">
      <assert id="PEPPOL-EN16931-R001"
        test="ram:BusinessProcessSpecifiedDocumentContextParameter/ram:ID" flag="fatal">[PEPPOL-EN16931-R001]-Business
      ...
      <assert id="PEPPOL-EN16931-R007" test="$profile != 'Unknown'" flag="fatal">[PEPPOL-EN16931-R007]-Business
        process MUST have an approved profile identifier.</assert>
      <assert id="PEPPOL-EN16931-R004"
        test="starts-with(normalize-space(ram:GuidelineSpecifiedDocumentContextParameter/ram:ID/text()),
    ...
    <rule context="ram:ApplicableHeaderTradeAgreement">
      ...
      <assert id="PEPPOL-EN16931-R006"
        test="count(ram:AdditionalReferencedDocument[ram:TypeCode='130']) &lt;=1" flag="fatal">[PEPPOL-EN16931-R006]-Only
        one invoiced object is allowed on document level</assert>
      <assert id="PEPPOL-EN16931-R080"
        test="count(ram:AdditionalReferencedDocument[ram:TypeCode='50']) &lt;=1" flag="fatal">[PEPPOL-EN16931-R080]-Only
        one project reference is allowed on document level</assert>
    </rule>
    ...
    <rule context="rsm:ExchangedDocument">
      <assert id="PEPPOL-EN16931-R002"
        ...
        flag="fatal">[PEPPOL-EN16931-R002]-No more than one note is allowed on document level.</assert>
    </rule>
    <rule context="ram:BuyerTradeParty">
      <assert id="PEPPOL-EN16931-R010" test="ram:URIUniversalCommunication/ram:URIID" flag="fatal">[PEPPOL-EN16931-R010]-Buyer
        electronic address MUST be provided</assert>
    </rule>
    <rule context="ram:SellerTradeParty">
      <assert id="PEPPOL-EN16931-R020" test="ram:URIUniversalCommunication/ram:URIID" flag="fatal">[PEPPOL-EN16931-R020]-Seller
        electronic address MUST be provided</assert>
    </rule>
    <rule
    ...
    <rule
      ...
      <assert id="PEPPOL-EN16931-R061"
        test="../ram:SpecifiedTradePaymentTerms/ram:DirectDebitMandateID" flag="fatal">[PEPPOL-EN16931-R061]-Mandate
    ...
    <rule context="ram:NetPriceProductTradePrice | ram:GrossPriceProductTradePrice">
      <assert id="PEPPOL-EN16931-R121"
        test="not(ram:BasisQuantity) or xs:decimal(ram:BasisQuantity) &gt; 0" flag="fatal">[PEPPOL-EN16931-R121]-Base
        quantity MUST be a positive number above zero.</assert>
    </rule>
    <!-- PEPPOL-EN16931-R044 and PEPPOL-EN16931-R046 are not needed due to lack of elements for the
    EN. -->
    <!-- Price -->
    <rule
    ...
    <rule
      context="ram:URIID[@schemeID = '0096'] | ram:ID[@schemeID = '0096'] | ram:GlobalID[@schemeID = '0096']">
    ...
    <rule
      context="ram:URIID[@schemeID = '0198'] | ram:ID[@schemeID = '0198'] | ram:GlobalID[@schemeID = '0198']">
    ...
    <rule
      context="ram:URIID[@schemeID = '0208'] | ram:ID[@schemeID = '0208'] | ram:GlobalID[@schemeID = '0208']">
    ...
    <rule
      context="ram:URIID[@schemeID = '0201'] | ram:ID[@schemeID = '0201'] | ram:GlobalID[@schemeID = '0201']">
    ...
    <rule
      context="ram:URIID[@schemeID = '0210'] | ram:ID[@schemeID = '0210'] | ram:GlobalID[@schemeID = '0210']">
    ...
    <rule
      context="ram:URIID[@schemeID = '0211'] | ram:ID[@schemeID = '0211'] | ram:GlobalID[@schemeID = '0211']">
...
-->
  ...
  <pattern>
    ...
    <rule context="ram:SellerTradeParty[$supplierCountry = 'NO']">
      <assert id="NO-R-002"
        ...
        flag="warning">[NO-R-002]-Most invoice issuers are required to append "Foretaksregisteret"
        to
  ...
  <pattern>
    <let name="DKSupplierCountry"
      value="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:PostalTradeAddress/ram:CountryID" />
    <let name="DKCustomerCountry"
      value="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID" />
    <!-- Document level -->
    <rule context="rsm:CrossIndustryInvoice[$DKSupplierCountry = 'DK']">
      ...
      <assert id="DK-R-002"
        ...
        flag="fatal">[DK-R-002]-Danish suppliers MUST provide legal entity.</assert>
      <!--Check
      for Non VAT Tax code-->
      <assert id="DK-R-004"
      ...
      <assert id="DK-R-013"
        ...
        flag="fatal">[DK-R-013]-For Danish Suppliers it is mandatory to use schemeID when GlobalID
    ...
    <rule
      ...
      <assert id="DK-R-005"
        ...
        flag="fatal">[DK-R-005]-For Danish suppliers the following Payment means type codes are
      ...
      <assert id="DK-R-006"
        ...
        flag="fatal">[DK-R-006]-For Danish suppliers, bank account and registration account are
      ...
      <assert id="DK-R-007"
        ...
        flag="fatal">[DK-R-007]-For Danish suppliers DirectDebitMandateID and CreditorReferenceID
      ...
      <assert id="DK-R-008"
        ...
        flag="fatal">[DK-R-008]-For Danish Suppliers PaymentReference is mandatory and MUST start
        with 01#, 04# or 15# (kortartkode), and PayeePartyCreditorFinancialAccount/IBANID (Giro
        kontonummer) is mandatory and must be 7 characters long, when payment means equals 50 (Giro)</assert>
      <assert id="DK-R-009"
        test="not((ram:TypeCode = '50')
        ...
        flag="fatal">[DK-R-009]-For Danish Suppliers if the PaymentReference is prefixed with 04# or
      ...
      <assert id="DK-R-011"
        ...
        flag="fatal">[DK-R-011]-For Danish Suppliers if the PaymentReference is prefixed with 71# or
    ...
    <rule
      ...
      <assert id="DK-R-003"
        test="not((ram:SpecifiedTradeProduct/ram:DesignatedProductClassification/ram:ClassCode/@listID = 'TST')
  ...
  <pattern>
    ...
    <rule context="ram:SellerTradeParty[$supplierCountry = 'IT']">
      <assert id="IT-R-002" test="(ram:PostalTradeAddress/ram:LineOne)" flag="fatal">
        [IT-R-002]-BT-35 (Seller address line 1) - Italian suppliers MUST provide the postal address
        line 1 - I fornitori italiani devono indicare l'indirizzo postale.</assert>
      <assert id="IT-R-003" test="(ram:PostalTradeAddress/ram:CityName)" flag="fatal">
        [IT-R-003]-BT-37 (Seller city) - Italian suppliers MUST provide the postal address city - I
        fornitori italiani devono indicare la città di residenza.</assert>
      <assert id="IT-R-004" test="(ram:PostalTradeAddress/ram:PostcodeCode)" flag="fatal">
        [IT-R-004]-BT-38 (Seller post code) - Italian suppliers MUST provide the postal address post
        code - I fornitori italiani devono indicare il CAP di residenza.</assert>
    </rule>
  </pattern>
  <!-- Swedish rules -->
  <pattern>
    ...
    <rule
      ...
      <assert id="SE-R-003" test="string(number(ram:ID)) != 'NaN'" flag="fatal">[SE-R-003]-Swedish
        organisation numbers SHOULD be numeric.</assert>
      <assert id="SE-R-004" test="string-length(normalize-space(ram:ID)) = 10" flag="fatal">[SE-R-004]-Swedish
        organisation numbers consist of 10 characters.</assert>
      <assert id="SE-R-013" test="u:checkSEOrgnr(normalize-space(ram:ID))" flag="fatal">[SE-R-013]-The
    ...
    <rule
      context="//ram:ApplicableTradeTax[/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty[ram:PostalTradeAddress/ram:CountryID = 'SE']/ram:SpecifiedTaxRegistration[substring(ram:ID[@schemeID = 'VA'], 1, 2) = 'SE'] and /rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID = 'SE'] | //ram:CategoryTradeTax[/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty[ram:PostalTradeAddress/ram:CountryID = 'SE']/ram:SpecifiedTaxRegistration[substring(ram:ID[@schemeID = 'VA'], 1, 2) = 'SE'] and /rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID = 'SE']">
      <assert id="SE-R-006"
  ...
  <pattern>
    <let name="supplierCountryIsNL"
      value="(upper-case(normalize-space(/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:PostalTradeAddress/ram:CountryID)) = 'NL')" />
    <let name="customerCountryIsNL"
      value="(upper-case(normalize-space(/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress/ram:CountryID)) = 'NL')" />
    <let name="taxRepresentativeCountryIsNL"
      value="(upper-case(normalize-space(/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTaxRepresentativeTradeParty/ram:PostalTradeAddress/ram:CountryID)) = 'NL')" />

    <rule
      context="/rsm:CrossIndustryInvoice/rsm:ExchangedDocument[some $code in tokenize('81 83 381 396 532', '\s') satisfies normalize-space(ram:TypeCode) = $code][$supplierCountryIsNL]">
      ...
      <assert id="NL-R-001"
        ...
        (ram:ApplicableHeaderTradeSettlement/ram:InvoiceReferencedDocument/ram:IssuerAssignedID)</assert>
    </rule>

    <rule
      context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:PostalTradeAddress[$supplierCountryIsNL]">
      <!-- Original rule in NLCIUS: BR-NL-3 -->
      <assert id="NL-R-002" test="ram:LineOne and ram:CityName and ram:PostcodeCode" flag="fatal">[NL-R-002]-For
        suppliers in the Netherlands the supplier's address
        (ram:SellerTradeParty/ram:PostalTradeAddress) MUST contain street name (ram:LineOne), city
        (ram:CityName) and post code (ram:PostcodeCode)</assert>
    </rule>

    <rule
      context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTradeParty/ram:SpecifiedLegalOrganization/ram:ID[$supplierCountryIsNL]">
    ...
    <rule
      context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:PostalTradeAddress[$supplierCountryIsNL and $customerCountryIsNL]">
      <!-- Original rule in NLCIUS: BR-NL-4 -->
      <assert id="NL-R-004" test="ram:LineOne and ram:CityName and ram:PostcodeCode" flag="fatal">[NL-R-004]-For
        suppliers in the Netherlands, if the customer is in the Netherlands, the customer address
        (ram:BuyerTradeParty/ram:PostalTradeAddress) MUST contain street name (ram:LineOne), city
        (ram:CityName) and post code (ram:PostcodeCode)</assert>
    </rule>

    <rule
      context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:SpecifiedLegalOrganization/ram:ID[$supplierCountryIsNL and $customerCountryIsNL]">
    ...
    <rule
      context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:SellerTaxRepresentativeTradeParty/ram:PostalTradeAddress[$supplierCountryIsNL and $taxRepresentativeCountryIsNL]">
      <!-- Original rule in NLCIUS: BR-NL-5 -->
      <assert id="NL-R-006" test="ram:LineOne and ram:CityName and ram:PostcodeCode" flag="fatal">[NL-R-006]-For
        suppliers in the Netherlands, if the fiscal representative is in the Netherlands, the
        representative's address (ram:SellerTaxRepresentativeTradeParty/ram:PostalTradeAddress) MUST
        contain street name (ram:LineOne), city (ram:CityName) and post code (ram:PostcodeCode)</assert>
    </rule>

    <rule
      context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementHeaderMonetarySummation[$supplierCountryIsNL]">
      <!-- Original rule in NLCIUS: BR-NL-11 -->
      <assert id="NL-R-007"
        test="(normalize-space(/rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:TypeCode/text()) != '381' and
        ...
        of payment (ram:SpecifiedTradeSettlementPaymentMeans) if the payment is from customer to
        supplier</assert>
    </rule>

    <rule
      context="/rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeSettlement/ram:SpecifiedTradeSettlementPaymentMeans[$supplierCountryIsNL and $customerCountryIsNL]">
      <!-- Original rule in NLCIUS: BR-NL-12 -->
      <assert id="NL-R-008"
        test="normalize-space(ram:TypeCode) = '30' or
                ...
                normalize-space(ram:TypeCode) = '59'"
        flag="fatal">[NL-R-008]-For suppliers in the Netherlands, if the customer is in the
        Netherlands, the payment means code (ram:SpecifiedTradeSettlementPaymentMeans/ram:TypeCode)
        MUST be one of 30, 48, 49, 57, 58 or 59</assert>
    </rule>

    <rule
      context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:BuyerOrderReferencedDocument/ram:LineID[$supplierCountryIsNL]">
      ...
      <assert id="NL-R-009"
        ...
        flag="fatal">
        [NL-R-009]-For suppliers in the Netherlands, if an order line reference
        (ram:BuyerOrderReferencedDocument/ram:LineID) is used, there must be an order reference on
        the document level
        (rsm:SupplyChainTradeTransaction/ram:ApplicableHeaderTradeAgreement/ram:BuyerOrderReferencedDocument/ram:IssuerAssignedID)</assert>
    </rule>
  </pattern>
  ...
  <pattern>
    ...
    <!-- PEPPOL-EN16931-CL006 is omitted due to lack of description code for invoice period in CII
    syntax. -->
    ...
    <rule context="udt:DateTimeString">
      <assert id="PEPPOL-EN16931-F001"
        ...
        flag="fatal">[PEPPOL-EN16931-F001]-A date MUST be formatted YYYYMMDD.</assert>
    </rule>
    <rule
      ...
      <assert id="PEPPOL-EN16931-CL008"
        ...
        flag="fatal">[PEPPOL-EN16931-CL008]-Electronic address identifier scheme must be from the
        codelist "Electronic Address Identifier Scheme"</assert>
    </rule>
  </pattern>
</schema>
