...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:u="utils" schemaVersion="iso"
 ...
 <pattern>
    ...
    <rule context="ubl-creditnote:CreditNote[$supplierCountry = 'DK'] | ubl-invoice:Invoice[$supplierCountry = 'DK']">
      ...
      <assert id="DK-R-013"
              test="not(((boolean(cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID))
      ...
      <assert id="DK-R-015"
              test="not((normalize-space(cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cac:TaxScheme/cbc:ID/text()) = 'VAT')
